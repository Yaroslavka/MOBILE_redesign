...
<div class="sort_container">
   <div class="sort_top clearfix">
       <a class="sort_title" href="#">Сортировать</a>
       <a href="http://medbooking.com/child" class="child_doctor">Детские врачи</a>
    </div>
...
<div class="doctor_items_wrapper"><?php if(!empty($data)): ?>
    <?php foreach($data as $value): ?>
    <div class="doctor_item">
        <?php $this->renderPartial('//doctor/_single',array('model'=>$value)); ?>
    </div>
    <?php endforeach; ?>
