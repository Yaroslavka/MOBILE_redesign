...
<div id="handbook_patient" class="page handbook_patient">
    <div class="fixed_top_container">
        ...
        <div class="blog_top_menu_wrapper clearfix">
            <div class="left"><strong class="title">Справочник пациента</strong></div>
...
<div class="footer footer_two clearfix">
  <div class="bottom">
      <div class="menu_wrapper_bottom">
          <div class="search_specialist"><a href="<?php echo Yii::app()->createUrl('site/blogList'); ?>"><span><?php echo $this->link; ?></span></a></div>
...
<?php $this->renderPartial('//layouts/elements/handbooks',array('data'=>$this->data)); ?>
