...
<body>
<div id="services_single" class="page services_list">
    <div class="fixed_top_container">
        <?php $this->renderPartial('//layouts/elements/header'); ?>
        <div class="blog_top_menu_wrapper clearfix">
            <div class="left left_full"><strong class="title">Медицинские услуги</strong></div>
        </div>
    </div>
...
<div class="footer footer_two clearfix">
  <div class="bottom">
      <div class="menu_wrapper_bottom">
          <div class="search_specialist"><a class="full_link items_service" href="<?php echo Yii::app()->createUrl('site/serviceList'); ?>"><span><?php echo $this->link; ?></span></a></div>
