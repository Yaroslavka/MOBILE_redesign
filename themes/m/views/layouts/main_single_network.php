...
<div class="footer footer_two clearfix">
    <div class="bottom">
        <div class="menu_wrapper_bottom">
            <div class="all_clinic doc_ico"><a href="<?php echo Yii::app()->createUrl('search_clinic/setevaya'); ?>"><span>Все клинники</span></a></div>
            <div class="menu_footer"><a class="menu_footer_link" href="#nav-panel"></a></div>
        </div>
    </div>
</div>
