<div class="menu_nav_wrapper">
    <ul>
        ...
        <li><a href="<?php  echo Yii::app()->createUrl('/site/illnessList');?>">Справочник заболеваний</a></li>
        <li class="bottom_menu">
          <div class="top"><a class="more_url" href="http://medbooking.com/"><span>Перейти к основной версии сайта</span></a></div>
          <div class="bottom">&copy; Сopyright 2013 Medbooking.com.<br>Все права защищены.</div>
        </li>
    </ul>
</div>