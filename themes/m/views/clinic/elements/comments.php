<?php if(!empty($model->clinic_review_s_limit)): ?>
<div class="reviews_clinic_items_wrapper">
    <?php foreach($model->clinic_review_s_limit as $value): ?>
    ...
    <?php endforeach; ?>
    <?php if(!empty($this->limit)): ?><div class="more_wrap"><a class="more" href="<?php echo Yii::app()->createUrl('/clinic/comment',array('id'=>$model->id)); ?>">Еще отзывы</a></div><?php endif; ?>
</div><?php endif; ?>