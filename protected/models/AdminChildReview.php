...
class AdminChildReview extends CActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('clinic_id','exist','attributeName'=>'id','className'=>'AdminChildClinic','message'=>'Клиника для комментария не обнаружена'),
            array('doctor_id','exist','attributeName'=>'id','className'=>'AdminChildDoctor','message'=>'Доктор для комментария не обнаружен'),
    ...
    {
        return array(
            'review_clinic'=>array(self::BELONGS_TO,'AdminChildClinic','clinic_id'),
            'review_doctor'=>array(self::BELONGS_TO,'AdminChildDoctor','doctor_id'),
