...
class AdminChildClinicDoctor extends CActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('clinic_id','exist','attributeName'=>'id','className'=>'AdminChildClinic','message'=>'Клиника выбрана не верно'),
            array('doctor_id','exist','attributeName'=>'id','className'=>'AdminChildDoctor','message'=>'Доктор выбран не верно'),
    ...
    {
        return array(
            'c'=>array(self::BELONGS_TO,'AdminChildClinic','clinic_id'),
            'd'=>array(self::BELONGS_TO,'AdminChildDoctor','doctor_id'),
        );
    }
