...
class AdminNodeIllnessCategory extends CActiveRecord
{
    ...
    {
        return array(
            'illnes_s'=>array(self::HAS_MANY,'AdminNodeIllness','theme_id'),
            'illnes_uid'=>array(self::BELONGS_TO,'AdminUser','uid'),
        );
    }
