...
class AdminCategoryClinic extends CActiveRecord
{
    ...
    public function getParent_name()
    {
        if(!empty($this->parent_id)){
            $model=AdminCategoryClinic::model()->findByPk($this->parent_id);
            if(!empty($model->name)){
    ...
    public function rules()
    {
        return array(
            ...
            array('clinic_id','exist','attributeName'=>'id','className'=>'AdminClinic','message'=>'Клиника не обнаружена'),
            array('parent_id','exist','attributeName'=>'id','className'=>'AdminCategoryClinic','message'=>'Родительская услуга не обнаружена'),
    ...
    {
        return array(
            'catc_clinic'=>array(self::BELONGS_TO,'AdminClinic','clinic_id'),
            'catc_service'=>array(self::BELONGS_TO,'AdminCategoryClinic','parent_id'),
            'catc_category'=>array(self::BELONGS_TO,'AdminCategory','category_id'),
        );
    }
