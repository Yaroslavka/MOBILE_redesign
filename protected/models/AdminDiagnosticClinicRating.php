...
class AdminDiagnosticClinicRating extends CActiveRecord
{
    ...
    public function beforeValidate()
    {
        ...
        $this->rate=0;
        $this->rate10=0;
        $this->rate=$this->rate1+$this->rate2+$this->rate3;
    ...
    public function rules()
    {
        return array(
            ...
            array('nid','exist','attributeName'=>'id','className'=>'AdminDiagnosticClinic'),
        );
    }
